...
public class Logic
    ...
    /*my code from the week1 assignment here(also instructed to comment to explain what each method
    does*/
    ...
    //computes the perimeter of a rectangle given length and width
    public static double rectanglePerimeter(double length, double width){
        return ((length*2)+(width*2));
    }

    //computes area of a circle given radius
    public static double circleArea(double radius){
        return Math.pow(radius,2)*Math.PI;
    }

    //computes circumference of a circle given radius
    public static double circleCircumference(double radius){
        return 2*radius*Math.PI;
    }

    //computes area of a right triangle given base and height
    public static double rightTriangleArea(double base, double height){
        return 0.5*base*height;
    }

    //computes perimeter of a right triangle given base and height
    public static double rightTrianglePerimeter(double base, double height){
        return base + height + (Math.sqrt(Math.pow(base,2)+Math.pow(height,2))); /*Math.sqrt for
        hypotenuse */
    }

    //computes volume of a 3d box given length, width and depth
    public static double boxVolume(double length, double width, double depth){
        return length*width*depth;
    }

    //computes surface area of a 3d box given length, width and depth
    public static double boxSurfaceArea(double length, double width,
                                        double depth){
        return (2*length*width)+(2*length*depth)+(2*width*depth);
    }

    //computes sphere volume given radius
    public static double sphereVolume(double radius){
        return (4.0/3.0)*Math.PI*Math.pow(radius,3);
    }

    //computes sphere's surface area given radius
